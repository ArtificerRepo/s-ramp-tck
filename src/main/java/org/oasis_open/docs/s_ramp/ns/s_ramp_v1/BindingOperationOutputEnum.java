...
/**
 * <p>Java class for bindingOperationOutputEnum.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="bindingOperationOutputEnum">
...
public enum BindingOperationOutputEnum {
    ...
    BindingOperationOutputEnum(DerivedArtifactEnum v) {
        value = v;
    }
    ...
    public static BindingOperationOutputEnum fromValue(DerivedArtifactEnum v) {
        for (BindingOperationOutputEnum c: BindingOperationOutputEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
