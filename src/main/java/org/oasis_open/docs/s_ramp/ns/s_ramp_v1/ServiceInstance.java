 ...
 *       &lt;sequence>
 *         &lt;element name="uses" type="{http://docs.oasis-open.org/s-ramp/ns/s-ramp-v1.0}serviceInstanceTarget" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="describedBy" type="{http://docs.oasis-open.org/s-ramp/ns/s-ramp-v1.0}serviceInstanceTarget" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends ServiceImplementationModelType
{
    ...
    protected List<ServiceInstanceTarget> uses;
    protected List<ServiceInstanceTarget> describedBy;
     ...
     * 
     */
    public List<ServiceInstanceTarget> getUses() {
        if (uses == null) {
            uses = new ArrayList<ServiceInstanceTarget>();
        }
        return this.uses;
    }
     ...
     * 
     */
    public List<ServiceInstanceTarget> getDescribedBy() {
        if (describedBy == null) {
            describedBy = new ArrayList<ServiceInstanceTarget>();
        }
