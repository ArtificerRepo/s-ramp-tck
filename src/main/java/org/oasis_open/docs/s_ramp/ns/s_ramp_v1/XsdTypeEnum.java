...
/**
 * <p>Java class for xsdTypeEnum.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="xsdTypeEnum">
 ...
 * 
 */
@XmlType(name = "xsdTypeEnum")
@XmlEnum(DerivedArtifactEnum.class)
public enum XsdTypeEnum {

    @XmlEnumValue("XsdType")
    XSD_TYPE(DerivedArtifactEnum.XSD_TYPE);
    private final DerivedArtifactEnum value;

    XsdTypeEnum(DerivedArtifactEnum v) {
        value = v;
    }
    ...
    public static XsdTypeEnum fromValue(DerivedArtifactEnum v) {
        for (XsdTypeEnum c: XsdTypeEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
