...
/**
 * <p>Java class for actorEnum.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="actorEnum">
...
public enum ActorEnum {
    ...
    public static ActorEnum fromValue(BaseArtifactEnum v) {
        for (ActorEnum c: ActorEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
