...
public enum InformationTypeEnum {
    ...
    INFORMATION_TYPE(BaseArtifactEnum.INFORMATION_TYPE);
    private final BaseArtifactEnum value;

    InformationTypeEnum(BaseArtifactEnum v) {
        value = v;
    }
    ...
    public static InformationTypeEnum fromValue(BaseArtifactEnum v) {
