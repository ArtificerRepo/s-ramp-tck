...
/**
 * <p>Java class for effectEnum.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="effectEnum">
 ...
 * 
 */
@XmlType(name = "effectEnum")
@XmlEnum(BaseArtifactEnum.class)
public enum EffectEnum {

    @XmlEnumValue("Effect")
    EFFECT(BaseArtifactEnum.EFFECT);
    private final BaseArtifactEnum value;

    EffectEnum(BaseArtifactEnum v) {
        value = v;
    }
    ...
    public static EffectEnum fromValue(BaseArtifactEnum v) {
        for (EffectEnum c: EffectEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
